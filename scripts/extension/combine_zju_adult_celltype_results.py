...
IN=ROOT/'results'/'zju_cellatlas_adult_celltype_refined_matching_by_context'
OUT=ROOT/'results'/'extension_forward_visibility'/'hcl_adult_celltype'
OUT.mkdir(parents=True, exist_ok=True)
files={
 'refined_formal_abs_summary.csv':'zju_hcl_adult_celltype_refined_formal_abs_summary_combined.csv',
 'refined_formal_abs_by_repeat.csv':'zju_hcl_adult_celltype_refined_formal_abs_by_repeat_combined.csv',
 'refined_matching_qc_summary.csv':'zju_hcl_adult_celltype_refined_matching_qc_summary_combined.csv',
 'refined_matching_qc_by_repeat.csv':'zju_hcl_adult_celltype_refined_matching_qc_by_repeat_combined.csv',
}
...
summary=pd.read_csv(OUT/'zju_hcl_adult_celltype_refined_formal_abs_summary_combined.csv')
...
over.to_csv(OUT/'zju_hcl_adult_celltype_metric_overview.csv', index=False)
print('[write]', OUT/'zju_hcl_adult_celltype_metric_overview.csv', over.shape)
by_context=summary.groupby(['condition','metric']).agg(
    units=('auprc_mean','size'),
    auprc_mean=('auprc_mean','mean'),
    auprc_gt_05=('auprc_mean', lambda x:int((x>0.5).sum())),
    auroc_mean=('auroc_mean','mean'),
...
by_context.to_csv(OUT/'zju_hcl_adult_celltype_metric_by_context.csv', index=False)
print('[write]', OUT/'zju_hcl_adult_celltype_metric_by_context.csv', by_context.shape)
qc=pd.read_csv(OUT/'zju_hcl_adult_celltype_refined_matching_qc_summary_combined.csv')
...
qc_over.to_csv(OUT/'zju_hcl_adult_celltype_qc_overview.csv', index=False)
print('[write]', OUT/'zju_hcl_adult_celltype_qc_overview.csv', qc_over.shape)
